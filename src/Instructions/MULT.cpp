...
MULTInstruction::MULTInstruction(std::string instructionText, std::string tag, int line) : Instruction(tag, line){
  operator_ = "MULT";
...
void MULTInstruction::parseInstruction(std::string instructionText) {
...
void MULTInstruction::execute(Memory* memory,  InputTape* iTape, OutputTape* oTape, std::map<std::string,int> tagMap, int pc) {
}